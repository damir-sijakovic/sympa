 ...
 */
final class Version20240907101342 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE article (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, slug LONGTEXT DEFAULT NULL, uuid VARCHAR(36) DEFAULT NULL, group_uuid VARCHAR(36) DEFAULT NULL, type VARCHAR(32) NOT NULL, sku LONGTEXT DEFAULT NULL, price DOUBLE PRECISION DEFAULT NULL, quantity INT DEFAULT NULL, content LONGTEXT DEFAULT NULL, metadata JSON DEFAULT NULL, excerpt VARCHAR(512) NOT NULL, author VARCHAR(255) NOT NULL, image LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, modified_at DATETIME NOT NULL, active TINYINT(1) NOT NULL, meta_description VARCHAR(255) DEFAULT NULL, og_title VARCHAR(255) DEFAULT NULL, og_description VARCHAR(255) DEFAULT NULL, og_url VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_23A0E662B36786B (title), UNIQUE INDEX UNIQ_23A0E66989D9B62 (slug), UNIQUE INDEX UNIQ_23A0E66D17F50A6 (uuid), UNIQUE INDEX UNIQ_23A0E66F8250BD6 (group_uuid), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE article_category (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, article_id INT DEFAULT NULL, INDEX IDX_53A4EDAA12469DE2 (category_id), INDEX IDX_53A4EDAA7294869C (article_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE article_tag (id INT AUTO_INCREMENT NOT NULL, tag_id INT DEFAULT NULL, article_id INT DEFAULT NULL, INDEX IDX_919694F9BAD26311 (tag_id), INDEX IDX_919694F97294869C (article_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE category (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, slug LONGTEXT DEFAULT NULL, type VARCHAR(32) NOT NULL, parent INT NOT NULL, description VARCHAR(255) NOT NULL, image VARCHAR(255) NOT NULL, visible TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_64C19C15E237E06 (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
